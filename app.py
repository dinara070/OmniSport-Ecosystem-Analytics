...
def render_dashboard(df):
    ...
    with st.expander("👋 Вітаємо в командному центрі OmniSport Pro!

Ми дуже раді, що ви з нами! OmniSport Pro — це більше, ніж просто набір інструментів; це ваш надійний помічник у спорті. Ми допоможемо структурувати вашу рутину, щоб ви могли сфокусуватися на головному — на вдосконаленні своїх навичок та перемогах. Нехай цей центр стане стартовим майданчиком для ваших найамбітніших цілей. Успіхів!", expanded=True):
        st.markdown("""
