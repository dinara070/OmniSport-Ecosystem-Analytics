...
def render_dashboard():
    ...
    # --- ДОДАНИЙ ТЕКСТОВИЙ БЛОК ---
    st.markdown("""
    **Вітаємо в головному командному центрі OmniSport Pro!** 🎯
    
    Цей розділ створений для швидкого моніторингу ключових показників вашої команди. Тут ви можете:
    * **Оцінити загальний стан:** побачити кількість активних гравців у ростері.
    * **Визначити рекорди:** швидко знайти максимальні показники швидкості та витривалості серед усіх спортсменів.
    * **Виявити лідерів:** проаналізувати зведену таблицю на основі **PER (Player Efficiency Rating)** — комплексного рейтингу, що враховує фізичні дані та результативність.
    """)
    
    st.info("💡 **Порада:** Використовуйте бічне меню ліворуч, щоб перейти до глибшої аналітики, порівняння гравців (H2H) або налаштування тактики.")
    st.divider()
    # ------------------------------
    ...
    # Додано невеликий підпис до таблиці для контексту
    st.caption("Гравці відсортовані за їхнім рейтингом ефективності (від найвищого до найнижчого). Чим насиченіший синій колір — тим вищий показник.")
